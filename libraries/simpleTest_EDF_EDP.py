...
def test_EDP3():
    path = "./unit_testing_tasks/EDP_test_3.csv"
    dl = dataloader.DataLoader(path)
    TT, ET= dl.loadFile()
...
def test_EDP4():
    path = "./unit_testing_tasks/EDP_test_4.csv"
    dl = dataloader.DataLoader(path)
    TT, ET= dl.loadFile()
...
def test_EDF_EDP1():
    path = "./unit_testing_tasks/EDF_EDP_test_1.csv"
    dl = dataloader.DataLoader(path)
    TT, ET= dl.loadFile()
    pslist = []
    ps = PollingServer(name='ps1', duration=500, period=10000, deadline=5000, tasks=ET, separation=1) 
...
def test_EDF_EDP2():
    path = "./unit_testing_tasks/EDF_EDP_test_2.csv"
    dl = dataloader.DataLoader(path)
    TT, ET= dl.loadFile()
    pslist = []
...
def test_EDF_EDP3():
    path = "./unit_testing_tasks/EDF_EDP_test_3.csv"
    dl = dataloader.DataLoader(path)
    TT, ET= dl.loadFile()
    pslist = []
